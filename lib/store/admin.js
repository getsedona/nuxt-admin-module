...
export const getters = {
  ...
  /* blockPropsDefaults: (store, getters) => (componentName = '') => {
    const props = getters.blockMetaByComponent(componentName)
    if (props === undefined) {
      return {}
    }
...
export const LOAD_BLOCK_META = 'load block meta info'
...
export const mutations = {
  ...
  [LOAD_BLOCK_META](store, { block = {} }) {
    Vue.set(store.blocks, store.blocks.length, block)
  },
}
